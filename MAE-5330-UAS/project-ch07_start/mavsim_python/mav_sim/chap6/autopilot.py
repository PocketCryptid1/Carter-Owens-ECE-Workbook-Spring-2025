...
class SequentialLoopClosureParameters:
    ...
    def __init__(self) -> None:
        ...
        self.yaw_limit=1.0                  # limit: max amplitude for the control
        ...
        self.alt_limit=np.radians(30)       # Altitude change limit (note that while this is altitude control, it effects theta_c, so limit is in radians)
...
class Autopilot:
    ...
    def update(self, cmd: MsgAutopilot, state: MsgState) -> tuple[MsgDelta, MsgState]:
        ...
        # construct control outputs and commanded states (don't modify the code below)

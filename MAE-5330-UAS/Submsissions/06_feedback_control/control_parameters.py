...
pitch_kp: float = (wn_theta_squared - TF.a_theta2) / TF.a_theta3
pitch_kd: float = (2.0 * zeta_theta * wn_theta - TF.a_theta1) / TF.a_theta3
...
altitude_kp: float = 2.0 * zeta_altitude * wn_altitude / (K_theta_DC * Vg)
